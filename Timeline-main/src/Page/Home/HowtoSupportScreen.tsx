...
/**
 * How to Support Screen
 * 
*/
export function HowtoSupportScreen() {
  ...
  const housingServices = serviceData.filter(service => service.serviceType.includes("How to Support") &&
    service.users.includes(UserType)); const imageMap = {
    ...
    return (
      <>
        ...
        <View style={{ marginVertical: 20, marginLeft: 30 }}>
          <View style={{ marginVertical: 20, marginLeft: 30 }}>
            <Image source={imageMap[service.image]} style={{ width: 100, height: 100 }} />
          </View>
        </View>
      </>
    );
