...
export function LegalScreen() {
  ...
  const housingServices = serviceData.filter(service => service.serviceType.includes("Legal Services") &&
  ...
  const imageMap = {
    ...
    "Image/serviceLogo/Court_Accompaniment.png": require('Image/serviceLogo/DVR.png'),
  };
