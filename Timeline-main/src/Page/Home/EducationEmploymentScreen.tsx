...
/**
 * DomesticAbuseSupportScreen
 * 
*/
export function EducationEmploymentScreen() {
  ...
  const housingServices = serviceData.filter(service =>
    service.serviceType.includes("Education and Employment") &&
  ...
  return (
    <BgView style={styles.container}>
      <ScrollView>
        ...
        <TitleBar title={'Education and Employment'} />
