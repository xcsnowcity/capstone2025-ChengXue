 ...
 * 
*/
export function FamilyServiceScreen() {
  ...
  const housingServices = serviceData.filter(service => service.serviceType.includes("Family Services") &&
  ...
  return (
    <BgView style={styles.container}>
      <ScrollView>
        ...
        <TitleBar title={'Family Services'} />
